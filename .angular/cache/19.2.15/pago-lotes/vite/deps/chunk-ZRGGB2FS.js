...
var IntFields = /* @__PURE__ */ new Set(["accessTokenSize", "durationMs", "idTokenSize", "matsSilentStatus", "matsHttpStatus", "refreshTokenSize", "queuedTimeMs", "startTimeMs", "status", "multiMatchedAT", "multiMatchedID", "multiMatchedRT", "unencryptedCacheCount", "encryptedCacheExpiredCount", "oldAccountCount", "oldAccessCount", "oldIdCount", "oldRefreshCount", "currAccountCount", "currAccessCount", "currIdCount", "currRefreshCount", "expiredCacheRemovedCount", "upgradedCacheCount"]);
...
var BrowserCacheManager = class _BrowserCacheManager extends CacheManager {
  ...
  updateV0ToCurrent(currentSchema, v0Keys, v1Keys, correlationId) {
    return __async(this, null, function* () {
      ...
      for (const v0Key of [...v0Keys]) {
        ...
        const decryptedData = isEncrypted(parsedV0Value) ? yield this.browserStorage.decryptData(v0Key, parsedV0Value, correlationId) : parsedV0Value;
        let expirationTime;
        if (decryptedData) {
  ...
  generateCredentialKey(credential) {
    ...
    const credentialKey = [`${PREFIX}.${CREDENTIAL_SCHEMA_VERSION}`, credential.homeAccountId, credential.environment, credential.credentialType, familyId, credential.realm || "", credential.target || "", credential.requestedClaimsHash || "", scheme];
  ...
  generateAccountKey(account) {
    ...
    const accountKey = [`${PREFIX}.${ACCOUNT_SCHEMA_VERSION}`, account.homeAccountId, account.environment, homeTenantId || account.tenantId || ""];
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-HZVTCZ42.js");
    }
  } catch (e) {
  }
  return void 0;
...
*/
//# sourceMappingURL=chunk-ZRGGB2FS.js.map
